...
export default function AddNoteScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      // Convert exercises to format without id field
      ...
      await saveWorkoutNote(user.uid, noteData);

      // Navigate back to notes view
      router.back();
    } catch (error) {
      console.error("Error saving note:", error);
      showDialog("Failed to save workout note. Please try again.");
    }
  };
